    ...
    def generate_new_csv(self):
        ...
        if int(self.asc_codes_count) <= 400:
            ...
            for asc_code in self._asc_codes[::-1]:
                ...
                with open(os.path.join(self.new_file_dir, csv_name), 'w+', newline='') as csvfile:
                    ...
                    for count, row in enumerate(csv_datas):
                        if count == 1:
                            ...
                            row[0] = random.choice(self._partNos)
            ...
            for asc_code in self._asc_codes:
                ...
                with open(os.path.join(self.new_file_dir, csv_name), 'r', newline='') as csvfile:
                    writer = csv.writer(csvfile)
                    lines = 0
